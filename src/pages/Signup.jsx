...
/*
 * signup page. same as login — big google button on top, email/password
 * form below as fallback. google signup and login are the same thing
 * on the backend (it creates or finds the user automatically). shows
 * the ten lakh bonus message. route is /signup in App.jsx.
 */
